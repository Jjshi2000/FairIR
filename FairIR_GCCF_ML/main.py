...
run_id = f"FairIR_GCCF_k{K}_tau{tau:g}"   
...
class GCN(nn.Module):
    ...
    def forward(self, u_batch,i_batch,j_batch):    
        ...
        loss_fake = loss_fake_male + loss_fake_female + 0.5*loss_info_nce_male + 0.5*loss_info_nce_female 
