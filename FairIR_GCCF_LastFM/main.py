...
testing_loader_loss = DataLoader(testing_dataset_loss,
        batch_size=test_dict_count, shuffle=False, num_workers=20)
...
val_loader_loss = DataLoader(val_dataset_loss,
        batch_size=val_dict_count, shuffle=False, num_workers=20)
...
for epoch in range(41):
    ...
    loss_str='loss' 
    loss_str+=' task:'+str(train_loss_task)+'\t noise:'+str(train_loss_noise)
