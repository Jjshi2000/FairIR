...
# print("train_dict sample:", list(train_dict.items())[:2])  
...
print("users_features shape:", users_features.shape)
...
testing_loader_loss = DataLoader(testing_dataset_loss,
        batch_size=test_dict_count, shuffle=False, num_workers=12)
