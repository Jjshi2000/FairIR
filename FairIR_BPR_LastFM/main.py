...
noise_optimizer = torch.optim.AdamW(model.parameters(), lr=0.001, weight_decay=1e-5)
...
testing_loader_loss = DataLoader(testing_dataset_loss,
        batch_size=test_dict_count, shuffle=False, num_workers=10)
...
val_loader_loss = DataLoader(val_dataset_loss,
        batch_size=val_dict_count, shuffle=False, num_workers=10)
